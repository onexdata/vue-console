/**
 * vue-console - A console for Vue.
 * Based on: http://gh.amio.us/console.js (version 1.2.2 before the move to React)
 */
...
(function (factory) {
  ...
  Console.prototype.install = function (_Vue) {
    Vue = _Vue;
    ...
    if (process.env.NODE_ENV !== 'production' && version < 2) {
      warn(("vue-console (" + (install.version) + ") need to use Vue 2.0 or later (Vue: " + (Vue.version) + ")."));
      return
    }
  
    Object.defineProperty(Vue.prototype, '$console', {
      get: function get () { return Console }
    });
  ...
  Console.prototype.version = '1.0.0'
